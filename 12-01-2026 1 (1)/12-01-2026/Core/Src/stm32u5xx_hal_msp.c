...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PB2     ------> ADC1_IN17
    */
    GPIO_InitStruct.Pin = Level_Sensor_1_Pin|Level_Sensor_2_Pin|Level_Sensor_3_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB2     ------> ADC1_IN17
    */
    HAL_GPIO_DeInit(GPIOA, Level_Sensor_1_Pin|Level_Sensor_2_Pin|Level_Sensor_3_Pin);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PB9     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = EPROM_I2C_SCL_Pin|EPROM_I2C_SDA_Pin;
  ...
  */
    ...
    PD13     ------> I2C4_SDA
    */
    GPIO_InitStruct.Pin = LED_driver_scl_Pin|LED_driver_sda_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C1)
  {
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(EPROM_I2C_SCL_GPIO_Port, EPROM_I2C_SCL_Pin);

    HAL_GPIO_DeInit(EPROM_I2C_SDA_GPIO_Port, EPROM_I2C_SDA_Pin);
  ...
  else if(hi2c->Instance==I2C4)
  {
    ...
    PD13     ------> I2C4_SDA
    */
    HAL_GPIO_DeInit(LED_driver_scl_GPIO_Port, LED_driver_scl_Pin);

    HAL_GPIO_DeInit(LED_driver_sda_GPIO_Port, LED_driver_sda_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  */
    ...
    PE15     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = RTD_SPI_SCK_Pin|RTS_SPI_MISO_Pin|RTD_SPI_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  */
    ...
    PB15     ------> SPI2_MOSI
    */
    GPIO_InitStruct.Pin = Vaccum_SPI_SCK_Pin|Vacuum_SPI_MISO_Pin|Vacuum_SPI_MOSII_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PE15     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, RTD_SPI_SCK_Pin|RTS_SPI_MISO_Pin|RTD_SPI_MOSI_Pin);
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, Vaccum_SPI_SCK_Pin|Vacuum_SPI_MISO_Pin|Vacuum_SPI_MOSII_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM1)
  {
    ...
    PE10     ------> TIM1_CH2N
    */
    GPIO_InitStruct.Pin = Buzzer_control_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(Buzzer_control_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PB7     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = WIFI_UART_RTS_Pin|WIFI_UART_CTS_Pin|WIFI_UART_TX_Pin|WIFI_UART_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    */
    ...
    handle_GPDMA1_Channel3.Init.Request = GPDMA1_REQUEST_USART3_TX;
  ...
  */
    ...
    PC3     ------> USART6_TX
    */
    GPIO_InitStruct.Pin = DISPLAY_UART_CTS_Pin|Display_UART_RX_Pin|Display_UART_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    /* USART6 DMA Init */
    /* GPDMA1_REQUEST_USART6_TX Init */
    handle_GPDMA1_Channel1.Instance = GPDMA1_Channel1;
    handle_GPDMA1_Channel1.Init.Request = GPDMA1_REQUEST_USART6_TX;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART1)
  {
    ...
    PB7     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOB, WIFI_UART_RTS_Pin|WIFI_UART_CTS_Pin|WIFI_UART_TX_Pin|WIFI_UART_RX_Pin);
  ...
  else if(huart->Instance==USART6)
  {
    ...
    PC3     ------> USART6_TX
    */
    HAL_GPIO_DeInit(GPIOC, DISPLAY_UART_CTS_Pin|Display_UART_RX_Pin|Display_UART_TX_Pin);
