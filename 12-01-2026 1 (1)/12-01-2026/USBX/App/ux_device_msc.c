...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
UX_SLAVE_CLASS_STORAGE *Device_msc;
/* USER CODE END 0 */
...
VOID USBD_STORAGE_Activate(VOID *storage_instance)
{
  /* USER CODE BEGIN USBD_STORAGE_Activate */
	Device_msc = (UX_SLAVE_CLASS_STORAGE *)storage_instance;
                       ...
                       ULONG number_blocks, ULONG lba, ULONG *media_status)
{
  ...
  if (HAL_MMC_ReadBlocks(&hmmc1, data_pointer, lba, number_blocks, HAL_MAX_DELAY) != HAL_OK)
  {
                        ...
                        ULONG number_blocks, ULONG lba, ULONG *media_status)
{
  ...
  if (HAL_MMC_WriteBlocks(&hmmc1, data_pointer, lba, number_blocks, HAL_MAX_DELAY) != HAL_OK)
            {
                *media_status = UX_ERROR;
                return UX_ERROR;
            }
